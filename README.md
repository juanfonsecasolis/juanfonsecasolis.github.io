...
I have worked since 2013 as a software quality consultant, performing manual testing and end-to-end web functional test automation. I have a long experience using Selenium Webdriver with DotNet, but I am also familiar with Python and Java. A little od Appium and performance testing. Lately, I have been focused on Playwright automation with Typescript/Javascript). On 2024 I obtained the ISTQB CTFL 4.0. Take a look at my automation portfolio on [https://github.com/juanfonsecasolis-automation](https://github.com/juanfonsecasolis-automation) for more information. 
